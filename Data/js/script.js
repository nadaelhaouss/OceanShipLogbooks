...
var point1 = L.geoJSON(point1D, {
    onEachFeature: createPointPopup,
    pointToLayer: function(feature, latlng) {
        return L.marker(latlng, { 
            icon: windIcon,
            rotationAngle: rotate(feature) 
        });
    },
});

var point2 = L.geoJSON(point2D, {
    onEachFeature: createPointPopup,
    pointToLayer: function(feature, latlng) {
        return L.marker(latlng, { 
            icon: windIcon,
